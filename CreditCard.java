...
public abstract class CreditCard implements Serializable {
    ...
    /**
     * Validate if the card number belong to this type of credit card.
     * 
     * Use Template Method Design Pattern, subclasses need to implement this method.
     * 
     * @param creditCardNum
     *      the number of the credit card.
     * @return
     *      true if is this type of credit card, false otherwise.
     */
    ...
    /**
     * Check if currently credit card number is valid.
     * 
     * @return 
     *      true if valid false otherwise.
     */
    public boolean validate() {
        return validate(creditCardNum);
    }
